...
<div class="row align-items-center my-5">
          <div class="col-lg-7">
          <p>
              After adding your Item it's time to mint your NFT. if you create more items just input the item Id.
            </p>
          </div>
          <div class="col-lg-5">
          ...
          <form className="form-group row" onSubmit={(event) => {
            event.preventDefault()
            let itemId
            itemId = this.input.value.toString()
            this.props.mintNft(itemId)
          }}>
          <label className="col-sm-2 col-form-label"><b>Input the item Id</b></label>
